...
#
# Used to get the parts-of-speech tags that the NLTK can use
##########################################################################################################
class Tags(object):
	# list of tags that the nltk uses
	...
	# takes in a list of tagged texts and loops though getting counts of each tag in the tags list
